package com.example.LocateMe.ShakeServices;
...
import com.example.LocateMe.Contacts.ContactModel;
import com.example.LocateMe.Contacts.DbHelper;
                ...
                if (count == 3) {
                    ...
                    fusedLocationClient.getCurrentLocation(LocationRequest.PRIORITY_BALANCED_POWER_ACCURACY, new CancellationToken() {
                        ...
                        public void onSuccess(Location location) {
                            ...
                            if (location != null) {
                                ...
                                for (ContactModel c : list) {
                                    String message = "Hey, " + c.getName() + "I need help. Please urgently reach me out. Here are my coordinates.\n " + "http://maps.google.com/?q=" + location.getLatitude() + "," + location.getLongitude();
                                    smsManager.sendTextMessage(c.getPhoneNo(), null, message, null, null);
                                }
                            } else {
                                String message = "Hey, i need some help. Please reach me out, i'm unable to reach you.\n" + "GPS Error. Couldn't find location.";
                                SmsManager smsManager = SmsManager.getDefault();
                                DbHelper db = new DbHelper(SensorService.this);
                                List<ContactModel> list = db.getAllContacts();
                                for (ContactModel c : list) {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            ...
                            String message = "I am in Trouble, i need help. Please urgently reach me out.\n" + "GPS was turned off. Couldn't find location. Call your nearest Police Station.";
                            SmsManager smsManager = SmsManager.getDefault();
                            DbHelper db = new DbHelper(SensorService.this);
                            List<ContactModel> list = db.getAllContacts();
                            for (ContactModel c : list) {
